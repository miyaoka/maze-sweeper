...
public class GameManager0 : SingletonMonoBehaviour<GameManager0>{
	...
	float cellScale = 1;
	float cellSpan = .2f;
	public List<List<CellPresenter>> grid = new List<List<CellPresenter>> ();
	...
	void Start () {
		...
		update
			...
			.Subscribe (pos => cam.position = new Vector3(pos.x, cam.position.y, pos.z))
			.AddTo (this);
